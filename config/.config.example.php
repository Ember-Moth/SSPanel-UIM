...
$_ENV['apiUrl'] = '';                     // API地址，用于支付回调等，为空时使用baseUrl

// WebAPI
$_ENV['webAPI'] = true;                // 是否开启WebAPI功能
$_ENV['webAPIUrl'] = $_ENV['apiUrl'] !== '' ? $_ENV['apiUrl'] : $_ENV['baseUrl']; // WebAPI地址，为空时自动使用apiUrl或baseUrl
...
$_ENV['enable_redis_queue'] = false;  // 是否启用Redis队列系统（替代数据库邮件队列）
...
$_ENV['subUrl'] = $_ENV['apiUrl'] !== '' ? $_ENV['apiUrl'] : $_ENV['baseUrl']; // 订阅地址，为空时自动使用apiUrl或baseUrl
