    ...
    <div style="max-width: 580px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(32, 43, 54, 0.08);">
        ...
        <div style="padding: 40px;">
            <div style="text-align: center; margin-bottom: 35px;">
                ...
                <h2 style="margin: 20px 0 0; font-size: 20px; color: #2c3345; font-weight: 600;">每日流量报告</h2>
            </div>
            ...
            <div style="margin: 35px 0; text-align: center;">
                <p style="margin: 0 0 20px; font-size: 14px; color: #2c3345; line-height: 1.6;">
                    ...
                    总流量: {$enable_traffic}<br>
                    已用流量: {$used_traffic}<br>
                    剩余流量: {$unused_traffic}<br>
                    今日使用流量: {$lastday_traffic}<br>
                </p>
                <p style="margin: 20px 0 0; font-size: 14px; color: #2c3345; line-height: 1.6;">
                    {$text}
                </p>
            </div>
        </div>
