    ...
    <div style="max-width: 580px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(32, 43, 54, 0.08);">
        ...
        <div style="padding: 40px;">
            <div style="text-align: center; margin-bottom: 35px;">
                ...
                <h2 style="margin: 20px 0 0; font-size: 20px; color: #2c3345; font-weight: 600;">密码重置</h2>
            </div>

            <div style="margin: 35px 0; text-align: center;">
                <p style="margin: 0 0 20px; font-size: 14px; color: #2c3345; line-height: 1.6;">
                    你收到此邮件是因为你在 {$config['appName']} 系统申请了密码重置。如果非本人操作，请忽略此邮件。
                </p>
                <a href="{$resetUrl}" style="display: inline-block; padding: 12px 24px; background: linear-gradient(145deg, #f9fafb 0%, #f5f7f9 100%); border: 1px solid #e9ecef; border-radius: 8px; font-size: 14px; color: #2c3345; text-decoration: none; font-weight: 500;" target="_blank">点击重置密码</a>
            </div>
        </div>
